...
CREATE TABLE USER_T(
     ...
     DETAIL_ADDRESS VARCHAR2(100 BYTE),                 -- 상세 주소
...
CREATE TABLE INACTIVE_USER_T(
     ...
     DETAIL_ADDRESS VARCHAR2(100 BYTE),                 -- 상세 주소
     AGREE          NUMBER             NOT NULL,        -- 서비스 동의 여부(0:필수, 1:이벤트)                          
     PW_MODIFIED_AT DATE,                               -- 비밀번호 수정
     JOINED_AT      DATE,                               -- 가입일
     INACTIVES_AT   DATE,                               -- 휴면처리일
     CONSTRAINT PK_INACTIVE_USER PRIMARY KEY(USER_NO)
);


 -- 테스트용 INSERT
 INSERT INTO USER_T VALUES (USER_SEQ.NEXTVAL,'user1@naver.com', STANDARD_HASH('1111', 'SHA256'), '사용자1', 'M', '01012311111', '11111', '디지털로', '가산동', '101동 101호', 0, TO_DATE('20231001', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
 INSERT INTO USER_T VALUES (USER_SEQ.NEXTVAL,'user2@naver.com', STANDARD_HASH('2222', 'SHA256'), '사용자2', 'F', '01011795111', '12341', '백제고분로', '방이동', '111동 102호', 0, TO_DATE('20230801', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
 INSERT INTO USER_T VALUES (USER_SEQ.NEXTVAL,'user3@naver.com', STANDARD_HASH('3333', 'SHA256'), '사용자3', 'NO', '01011121312', '11876', '디지털로', '가산동', '166동 103호', 0, TO_DATE('20230601', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
