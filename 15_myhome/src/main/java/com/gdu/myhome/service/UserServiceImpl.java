  ...
  public void leave(HttpServletRequest request, HttpServletResponse response) {
    ...
    if(user == null) {
      try {
        ...
        PrintWriter out = response.getWriter();
        out.println("<script>");
        out.println("alert('회원 탈퇴를 수행할 수 없음')");
...
try {
  ...
  public ResponseEntity<Map<String, Object>> selectId(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      if (user == null) {
        resultMap.put("error", "User not logged in.");
      ...
      UserDto selectedUser = userMapper.selectId(map);

      if (selectedUser != null) {
        resultMap.put("userId", selectedUser.getEmail());
